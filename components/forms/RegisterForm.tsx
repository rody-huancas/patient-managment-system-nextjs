    ...
    <Form {...form}>
      ...
      >
        <section className="space-y-4">
          ...
          <p className="text-dark-700">Queremos saber más sobre Usted.</p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            ...
            <CustomFormField
              ...
              label="Número Proveedor de seguros"
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              label="Historial médico familiar (si procede)"
        ...
        <section className="space-y-6">
          ...
          <CustomFormField
            ...
            placeholder="Seleccionar el tipo de Indentificación"
          >
        ...
        <section className="space-y-6">
          ...
          <CustomFormField
            ...
            label="Doy mi consentimiento para el uso y divulgación de mi información para fines de tratamiento."
          />
        ...
        <SubmitButton isLoading={isLoading}>Envíar y Continuar</SubmitButton>
      </form>
    </Form>
  );
};
